...
const ContactUs = () => {
  return (
    <main>
      ...
      <section
        className="text-dark p-5 851px:px-48 851px:py-8 grid grid-cols-auto-fit gap-8"
      >
        <div className="flex flex-col gap-6">
          <div className="text-16px flex flex-col text-justify">
            <h1 className="uppercase font-lexendSemiBold text-20px">
              hubungi kami
            </h1>
            <p>Untuk mengetahui lebih lanjut tentang kami dan layanan kami, silakan isi formulir di sini dan kirimkan email kepada kami. Atau,</p>
          </div>
